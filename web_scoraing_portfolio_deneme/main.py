...
sql = '''CREATE TABLE IF NOT EXISTS dataeng(job_title text NOT NULL,\
publish varchar(30),\
company text,\
city varchar(200),\
description text,\
...
df01.to_sql('dataeng', engine, if_exists='append', index = False)
df02.to_sql('dataeng', engine, if_exists='append', index = False)
